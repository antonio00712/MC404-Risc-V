...
void pack(int input, int start_bit, int end_bit, char str[], int start_input){
    ...
    int j = 31-start_bit;
    for(int i = 31-start_input; i > 31-start_input-lsb; i--){
        str[j] = strbin[i];
        j--;
    }
...
int main()
{
    ...
    pack(data.opcode, 0, 6, ans, 0);

    if(data.type == R){
        pack(data.rd, 7, 11, ans, 0);
        pack(data.funct3, 12, 14, ans, 0);
        pack(data.rs1, 15, 19, ans, 0);
        pack(data.rs2, 20, 24, ans, 0);
        pack(data.funct7, 25, 31, ans, 0);

    }else if(data.type == I){
        pack(data.rd, 7, 11, ans, 0);
        pack(data.funct3, 12, 14, ans, 0);
        pack(data.rs1, 15, 19, ans, 0);
        pack(data.imm, 20, 31, ans, 0);
        
    }else if(data.type == S){
        pack(data.imm, 7, 11, ans, 0);
        pack(data.funct3, 12, 14, ans, 0);
        pack(data.rs1, 15, 19, ans, 0);
        pack(data.rs2, 20, 24, ans, 0);
        pack(data.imm, 25, 31, ans, 5);
        
    }else if(data.type == B){
        pack(data.imm, 7, 7, ans, 11);
        pack(data.imm, 8, 11, ans, 1);
        pack(data.funct3, 12, 14, ans, 0);
        pack(data.rs1, 15, 19, ans, 0);
        pack(data.rs2, 20, 24, ans, 0);
        pack(data.imm, 25, 30, ans, 5);
        pack(data.imm, 31, 31, ans, 12);
        
    }else if(data.type == U){
        pack(data.rd, 7, 11, ans, 0);
        pack(data.imm, 12, 31, ans, 0);
        
    }else{  // J
        pack(data.rd, 7, 11, ans, 0);
        pack(data.imm, 12, 19, ans, 12);
        pack(data.imm, 20, 20, ans, 11);
        pack(data.imm, 21, 30, ans, 1);
        pack(data.imm, 31, 31, ans, 20);
